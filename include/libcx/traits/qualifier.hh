...
template<typename T> proposition is_const = false;
template<typename T> proposition is_const<T const> = true;

template<typename T> proposition is_vola = false;
template<typename T> proposition is_vola<T volatile> = true;

template<typename T> proposition is_cv_qual = is_const<T> || is_vola<T>;
...
template<typename T> 
proposition ___is_refble = requires { typename lref<T>; };
...
template<typename T> proposition is_lref = false;
template<typename T> proposition is_lref<T&> = true;
template<typename T> proposition is_rref = false;
template<typename T> proposition is_rref<T&&> = true;
template<typename T> proposition is_ref = is_lref<T> || is_rref<T>;
