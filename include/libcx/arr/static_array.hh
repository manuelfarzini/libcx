...
template<typename Arr, typename E> propositio is_static_array_of = false;
template<typename T, isize Cap, typename S> propositio is_static_array_of<StaticArray<T, Cap, S>, T> = true;
